...
export default function ForceChangePasswordPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await apiClient.post('/auth/force-change-password', { currentPassword, newPassword });
            ...
            setError((err as { response?: { data?: { error?: string } } })?.response?.data?.error || t('forcePassword.errors.failed'));
        } finally {
            setIsLoading(false);
        }
    };
