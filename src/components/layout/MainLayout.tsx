...
import { Menu, X, Sun, Moon, Calendar, User, Package, Clock } from 'lucide-react';
...
export const MainLayout: React.FC = () => {
  const { isAuthenticated, isLoading, user, logout, sessionConfig } = useAuth();
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 lg:gap-4 group cursor-default">
              ...
              <div className="flex flex-col">
                <span className="font-black text-xs lg:text-sm tracking-tight text-foreground uppercase pt-1">Devoluciones</span>
                <div className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
                  <span className="text-[9px] lg:text-[10px] font-black text-muted-foreground tracking-widest uppercase opacity-60 hidden sm:inline">Control de Devoluciones</span>
                  <span className="text-[9px] lg:text-[10px] font-black text-muted-foreground tracking-widest uppercase opacity-60 inline sm:hidden">Devoluciones</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={cn(
            ...
            <div className="flex items-center gap-3 pl-1 pr-4 py-1 rounded-full border border-transparent hover:bg-white dark:hover:bg-white/5">
              ...
              <div className="flex flex-col min-w-0 hidden md:flex">
                <span className="text-[11px] font-black text-foreground truncate uppercase tracking-tight">{user?.fullName || 'Usuario'}</span>
