 ...
 * aplicación Mail.Send, validada por el área de TI de Sole. Distinto del
 * ONEDRIVE_CLIENT_ID/SECRET ya existente en este repo (ese es para OneDrive,
 * no para envío de correo — se usan variables MS_GRAPH_* separadas).
 */
