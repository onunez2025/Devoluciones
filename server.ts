...
function clearSharedCookie(res: any): void {
...
function redirectToSsoStatus(res: any, status: 'pending' | 'rejected' | 'error', reason?: string, retriesLeft?: number): void {
...
app.get('/api/auth/sso/authorize', (req: any, res: any) => {
...
app.get('/api/auth/sso/callback', async (req: any, res: any) => {
